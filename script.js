...
const translations = {
  fr: {
    ...
    'portfolio.p1.video.alt': "Démo de Recette : parcourir des rendus dans le fil, puis appliquer une recette à une nouvelle photo",
    ...
    'portfolio.p2.video.alt': "Vidéo de démonstration de la carte interactive CRAFT",
    'portfolio.p2.img1.alt': "Maquette du concept initial de la carte de sentiment CRAFT avec un curseur temporel",
    'portfolio.p2.img2.alt': "Version finale de l'outil CRAFT montrant l'évolution du sentiment des avis sur une carte du Quartier Latin, à Paris",
    ...
    'portfolio.p2.insight': "La première version affichait une heatmap continue. Cela supposait une interpolation à travers l'espace, alors que les données sont des points d'avis discrets et inégalement répartis. Pourtant, un pâté de maisons dense au centre-ville et un quartier résidentiel épars n'ont pas le même poids statistique. Dans cette première version, le dégradé encodait donc la quantité de données disponibles (pas forcément l'information recherchée). La solution a été de passer à des marqueurs individuels, colorés et affichés avec des opacités variables pour que densité et intensité ne se mélangent plus en une seule couleur trompeuse.",
    'portfolio.p2.solution': "Nous avons scrapé des avis Google, fait tourner une analyse de sentiment RoBERTa sur le texte lui-même (pas seulement les notes en étoiles), et affiché le résultat sur une carte Leaflet avec un curseur d'année (pour que le changement dans le temps soit la première chose mise en avant) et un curseur de période de moyennage. La décision la plus difficile a été de résister à l'envie de lisser les données, comme mentionné précédemment. Ce que nous avons également choisi de ne pas construire : un support multi-villes ou une version publique.",
    ...
    'portfolio.p3.img1.alt': "Studio VR d'architecture - capture du mode génération/visualisation",
    'portfolio.p3.img2.alt': "Studio VR d'architecture - capture du mode design",
    ...
    'portfolio.p4.img1.alt': "Schéma traduisant la position gauche-droite du ballon sur le terrain en une bande haptique sous les doigts de l'utilisateur",
    'portfolio.p4.img2.alt': "Vue caméra simulée testant la confiance de détection du ballon pour un emplacement candidat",
    'portfolio.p4.img3.alt': "Pipeline de vision par ordinateur : image caméra vers détection Python du ballon/terrain vers mouvement du moteur pas-à-pas Arduino",
    'portfolio.p4.img4.alt': "Schéma du matériel : Arduino, moteur pas-à-pas, courroie et poulie déplaçant le curseur touché par l'utilisateur",
    'portfolio.p4.img5.alt': "Erreur de localisation selon les positions de caméra testées (azimut/élévation), erreur minimale de 0,035 m",
    ...
    'creative.alpha.imgAlt': "Couverture de la Plaquette Alpha, une brochure de recrutement présentant le campus et la vie étudiante",
    ...
    'creative.guide.imgAlt': "Couverture du livret d'accueil conçu pour un voyage du Bureau des Élèves à Barcelone",
    ...
    'creative.poster.imgAlt': "Affiche d'événement conçue pour une association étudiante de Télécom Paris",
    ...
    'creative.website.imgAlt': "Illustration du poussin, mascotte créée pour ce portfolio",
    ...
    'creative.barcelonaRecap.imgAlt': "Vignette d'une vidéo récap du voyage à Barcelone organisé par le Bureau des Élèves",
    ...
    'creative.aix.imgAlt': "Vignette d'un carnet de voyage vidéo tourné dans le Sud de la France",
    ...
    'creative.flash.imgAlt': "Photographie au flash d'inspiration Y2K prise autour du plateau de Saclay",
    ...
    'creative.wei.imgAlt': "Vignette d'une vidéo récap du weekend d'intégration des 1A à Télécom Paris",
    ...
    'creative.film.imgAlt': "Photographie argentique prise lors d'un voyage en Europe",
    ...
    'creative.ski.imgAlt': "Vignette d'une vidéo récap d'un voyage au ski du Bureau des Élèves",
  ...
  ja: {
    ...
    'portfolio.p1.video.alt': "Recetteのデモ:フィードでルックを探し、レシピを新しい写真に適用する様子",
    ...
    'portfolio.p2.video.alt': "CRAFTインタラクティブマップのデモ動画",
    'portfolio.p2.img1.alt': "年代スライダー付きのCRAFT感情ヒートマップの初期コンセプトモックアップ",
    'portfolio.p2.img2.alt': "パリのカルチェ・ラタンの地図上でレビューの感情の推移を示す完成版CRAFTツール",
    ...
    'portfolio.p3.img1.alt': "VR建築スタジオ - 生成/可視化モードのスクリーンショット",
    'portfolio.p3.img2.alt': "VR建築スタジオ - デザインモードのスクリーンショット",
    ...
    'portfolio.p4.img1.alt': "ボールのピッチ上の左右位置を、ユーザーの指の下の触覚バンドに変換する図",
    'portfolio.p4.img2.alt': "候補位置に対するボール検出の信頼度をテストするシミュレートされたカメラ映像",
    'portfolio.p4.img3.alt': "コンピュータビジョンのパイプライン:カメラ映像からPythonによるボール・ピッチ検出、Arduinoステッピングモーターの動作まで",
    'portfolio.p4.img4.alt': "ハードウェア図:Arduino、ステッピングモーター、ベルトとプーリーがユーザーの触れるカーソルを動かす",
    'portfolio.p4.img5.alt': "テストした方位角・仰角のカメラ配置ごとの位置推定誤差、最小誤差0.035m",
  ...
  de: {
    ...
    'portfolio.p1.video.alt': "Recette-Demo: Looks im Feed durchstöbern und ein Rezept auf ein neues Foto anwenden",
    ...
    'portfolio.p2.video.alt': "Demo-Video der interaktiven CRAFT-Karte",
    'portfolio.p2.img1.alt': "Frühes Konzept-Mockup der CRAFT-Sentiment-Heatmap mit Jahres-Schieberegler",
    'portfolio.p2.img2.alt': "Fertiges CRAFT-Tool zeigt die Entwicklung des Bewertungs-Sentiments über die Zeit auf einer Karte des Quartier Latin in Paris",
    ...
    'portfolio.p2.videoCaption': "App Interface",
    ...
    'portfolio.p2.mediaConceptCaption': "Originale Idee",
    'portfolio.p2.mediaRealCaption': "Letzte Version",
    ...
    'portfolio.p3.img1.alt': "VR-Architekturstudio - Screenshot des Generierungs-/Visualisierungsmodus",
    'portfolio.p3.img2.alt': "VR-Architekturstudio - Screenshot des Designmodus",
    ...
    'portfolio.p4.img1.alt': "Diagramm, das die Links-rechts-Position des Balls auf dem Feld in ein haptisches Band unter den Fingern der Nutzerin überträgt",
    'portfolio.p4.img2.alt': "Simulierte Kameraansicht zum Testen der Erkennungssicherheit des Balls für eine Kandidatenposition",
    'portfolio.p4.img3.alt': "Computer-Vision-Pipeline: Kamerabild zu Python-Ball-/Feld-Erkennung zu Arduino-Schrittmotor-Bewegung",
    'portfolio.p4.img4.alt': "Hardware-Diagramm: Arduino, Schrittmotor, Riemen und Rolle bewegen den Cursor, den die Nutzerin berührt",
    'portfolio.p4.img5.alt': "Lokalisierungsfehler über getestete Azimut-/Elevations-Kamerapositionen, minimaler Fehler 0,035 m",
    ...
    'creative.alpha.imgAlt': "Titelseite der Plaquette Alpha, einer Werbebroschüre über Campus und Studierendenleben",
    ...
    'creative.guide.imgAlt': "Umschlag des Willkommensbooklets für eine Barcelona-Reise des Studierendenrats",
    ...
    'creative.poster.imgAlt': "Event-Plakat, gestaltet für einen Studierendenverein an der Télécom Paris",
    ...
    'creative.website.imgAlt': "Illustration des Küken-Maskottchens, erstellt für dieses Portfolio",
    ...
    'creative.barcelonaRecap.imgAlt': "Vorschaubild eines Rückblick-Videos zur Barcelona-Reise des Studierendenrats",
    ...
    'creative.aix.imgAlt': "Vorschaubild eines Reisetagebuch-Videos aus dem Süden Frankreichs",
    ...
    'creative.flash.imgAlt': "Y2K-inspirierte Blitzfotografie, aufgenommen rund um das Plateau de Saclay",
    ...
    'creative.wei.imgAlt': "Vorschaubild eines Rückblick-Videos vom Erstsemester-Willkommenswochenende der Télécom Paris",
    ...
    'creative.film.imgAlt': "Analogfoto, aufgenommen auf einer Reise durch Europa",
    ...
    'creative.ski.imgAlt': "Vorschaubild eines Rückblick-Videos einer Ski-Reise des Studierendenrats",
