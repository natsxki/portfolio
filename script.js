...
'how.b3.detail': `
        ...
        EYでのインターンでは、チームが実際にどうAIを使っているのかを知るため、社内4部門で12件のインタビューを行い、経営層向けの提言にまとめました。本当に役立つ情報は、ブリーフィング資料からではなく、人々が実際に働く様子を見たり、直接話を聞いたりする中から見えてきました。この感覚は、自分自身のプロジェクトにも通じています。建築を学ぶ博士課程の学生から「コントローラーでの設計は、試行錯誤するには遅すぎる」と聞き、友人2人とともに、主に音声で操作するVRツールを開発しました。推測だけで問題を決めつけるのではなく、実際にその現場にいる人と話すこと。その大切さを、ここから学びました。
      `,
...
'portfolio.p3.intro1': "きっかけは、建築を学ぶ博士課程の学生との会話でした。3Dの建物デザインを試作しながらアイデアを形にしていく作業が、いかに時間のかかるものかという話です。ボトルネックはアイデアそのものではなく、それを素早く形にするまでにある「摩擦」でした。",
...
'portfolio.p3.problem': "3Dの建物コンセプトを試行錯誤するには時間がかかります。大きなボトルネックは、アイデアを素早く目に見える3Dの形にするまでの摩擦です。特に、3Dソフトやゲーム、VRの操作に慣れていない建築家にとっては、そのハードルはさらに高くなります。",
...
'portfolio.p4.intro1': "2024年のTIPE (フランスの理工系グランゼコール入試における研究課題)のテーマはスポーツでした。周りの学生の多くがパフォーマンス分析に取り組む中、私が考えたのは別の問いでした。いま、試合を十分に楽しめていないのは誰だろう？視覚に障がいのある観客は、スタジアムの熱気を耳で感じることはできても、ボールが実際にどこにあるのかを追うことができません。",
