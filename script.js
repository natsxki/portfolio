...
'how.h2': "働き方",
    ...
    'how.b1.detail': `
            ...
            Télécom Parisの映像制作クラブComèteは、全学生がアクセスできるサイトに、年間5万枚を超える写真を掲載しています。そのため、自分が写っている一枚を探し出すのは意外と骨が折れます。そこで顔認識を使い、誰もがアーカイブの中から自分自身を見つけられる機能をプロトタイプしました。技術的には問題なく動いたのですが、生体データにまつわる課題を調べていくうちに、リリースしないという判断に至りました。これまでで一番難しかったプロダクトの決断は、何かを作ることではなく、あえて世に出さないと決めることでした。
          `,
