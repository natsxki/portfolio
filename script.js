...
const translations = {
  fr: {
    ...
    'portfolio.p1.more1': "La décision de traiter la recette comme un objet à part entière, a façonné tout mon produit. Le fil d\'actualité, le profil, l'éditeur : tout devait rendre les retouches lisibles et remixables, pas seulement afficher les images finies. C'est ce qui transforme un simple outil de retouche en uneboucle sociale.",
    'portfolio.p1.more2': "Je me suis inspirée du système de calques verrouillés de VSCO pour que les recettes restent structurées et reproductibles. On peut ajuster l'intensité du filtre choisi. J'ai aussi fait le choix de faire directement tourner les retouches sur l'appareil de l'utilisateur (ordinateur/téléphone) avec des shaders Skia, pour que chaque ajustement soit instantané. Une boucle sociale meurt vite dès qu'elle donne une impression d'attente.",
    'portfolio.p1.more3': "L'appli est pour l'instant en beta fermée. Je teste surtout la rétention, et je cherche comment l'améliorer via la gamification.",
    ...
    'portfolio.p2.intro1': "L'équipe de sciences sociales de l'école est venue nous voir avec une question de recherche ouverte : comment un événement fait-il évoluer la réputation d'un lieu ? La réputation est déjà difficile à évaluer : on pourrait uniquement se baser sur les notes Google Reviews - mais elles existent par milliers, et les utilisateurs attribuet une note de manière subjective. Il leur fallait pouvoir la voir, pas seulement la décrire.",
    'portfolio.p2.intro2': "Nous avons donc construit une carte interactive qui transforme les commentaires des avis publics en un signal lisible. On a scrapé des avis Google, fait tourner une analyse de sentiment avec un modèle RoBERTa pour transformer le texte libre en signal exploitable, puis affiché le tout sur une carte Leaflet, pour qu'un événement et ses répercussions se lisent comme un motif dans le temps. Je me suis chargée de l'UI/UX.",
    ...
    'portfolio.p3.intro2': "Nous avons donc construit un studio en réalité virtuelle, où les architectes façonnent leurs prototypes dans l'espace, mais en remplaçant les manettes par la voix. Confier deux manettes Quest à quelqu'un qui ne joue pas et attendre une manipulation 3D fluide, c'est beaucoup demander ; les commandes sont souvent l'obstacle principal. La voix contourne ce problème : on décrit ce qu'on veut oralement, et l'on obtient une première base de travail en quelques secondes. L'outil s'adapte ainsi à un large panel d'utilisateurs, expérimentés ou non. Sur ce projet, je me suis concentrée sur le design de l'interface et des interactions (UI/UX).",
    'portfolio.p3.media1Caption': "Phase de conception : j'ai ajouté un résumé par mots-clés généré par Gemini, pour montrer à l'utilisateur ce que le système a <i>compris</i> de ses descriptions.",
    ...
    'portfolio.p4.intro1': 'En 2024, le TIPE avait pour thème le sport. Je me suis intéressée à une question : qui ne peut pas profiter d\'un match aujourd\'hui ? Les spectateurs malvoyants entendent l\'ambiance du stade, mais perdent le fil de là où se trouve vraiment le ballon.',
    ...
    'portfolio.p4.more1b': 'Ces 6 m sont un compromis assumé : assez précis pour transmettre, tout en restant assez rapide pour donner une vraie impression de direct. C\'est également une valeur acceptable pour un système physique plutôt petit (d\'une douzaine de cm), où 6cm ne représentent plus que quelques millimètres.',
